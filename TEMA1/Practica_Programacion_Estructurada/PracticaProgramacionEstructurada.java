        ...
        while (!confirmacion_personaje_1) {
            ...
            switch (personaje_1) {
                case 1:
                    ...
                    vit_1 = 200; ataque_1 = 100; defensa_1 = 150; velocidad_1 = 50;
                ...
                case 2:
                    ...
                    vit_1 = 150; ataque_1= 200; defensa_1 = 50; velocidad_1 = 100;
                ...
                case 3:
                    ...
                    vit_1 = 100; ataque_1= 150; defensa_1 = 100; velocidad_1 = 150;
                ...
                case 5:
                    ...
                    while ((suma!=500)) {
                        ...
                        vit_1 = 0; ataque_1 = 0; defensa_1 = 0; velocidad_1 = 0;
        ...
        while (!confirmacion_personaje_2){
            ...
            switch (personaje_2) {
                case 1:
                    ...
                    System.out.println("VIT: 200 / Ataque: 100 / Defensa: 150 / Velocidad: 50");
                    vit_2 = 200; ataque_2= 100; defensa_2 = 150; velocidad_2 = 50;
                    System.out.println("Especial - Corazón valeroso: aumenta la defensa del Caballero y duplica su VIT");
                    break;
                case 2:
                    System.out.println("Has elegido " + nombre_personaje_2 + ". Estos son sus stats: ");
                    System.out.println("VIT: 150 / Ataque: 200 / Defensa: 50 / Velocidad: 100");
                    vit_2 = 150; ataque_2= 200; defensa_2 = 50; velocidad_2 = 100;
                    System.out.println("Especial - Grito de Guerra: aumenta el ataque pero reduce su VIT.");
                    break;
                case 3:
                    System.out.println("Has elegido a " + nombre_personaje_2 + ". Estos son sus stats: ");
                    System.out.println("VIT: 100 / Ataque: 150 / Defensa: 100 / Velocidad: 150");
                    vit_2 = 100; ataque_2= 150; defensa_2 = 100; velocidad_2 = 150;
                    System.out.println("Especial - Furia Berserker: aumenta todos los stats 2 rounds.");
                    break;
                case 4:
                    System.out.println("Has elegido a " + nombre_personaje_2 + ". Estos son sus stats: ");
                ...
                case 5:
                    ...
                    while ((suma!=500)) {
                        System.out.println("Nota: Recuerda, no debes poner mas de 200 en un atributo y como mínimo 1 en cada uno");
                        System.out.println("La suma de todos no puede ser mayor a 500");
                        vit_2 = 0; ataque_2 = 0; defensa_2 = 0; velocidad_2 = 0;
...
// Aquí están los parámetros con los que se irán empezando cada turno y serán utilizados según el comando de cada ronda.
        ...
        while ((vit_1>0) && (vit_2>0)) {
            ...
            System.out.println(primer_ataque_1 + "y" + primer_ataque_2);
...
//Aquí empiezan los turnos, este primer bloque indica qué pasaría si atacase primero el jugador 1.
            if (primer_ataque_1>primer_ataque_2) {
                ...
                } else if ((ataque_1 == 3) && (contador_especial_1 != 0)) {
                ...
                } else if ((ataque_2 == 3) && (contador_especial_2 != 0)) {
                    System.out.println("¡Ya has gastado la habilidad especial! Pierdes el turno.");
                }
                ...
                if ((accion_1 == 1) && (accion_2 == 3) && (critico_1 >= 25)) {
                    vit_2 = vit_2 - (ataque_jugador1);
                    vit_1 = vit_1 - (especial_1);
                    System.out.println(name_1 + " realiza un golpeo tremendo haciendo tambalear a " + name_2 + " e hiriéndolo de gravedad. " + name_2 + "realiza su ataque especial buscando sorprender.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
                if ((accion_1 == 1) && (accion_2 == 3) && (critico_1 <= 25)) {
                    vit_2 = vit_2 - ((ataque_jugador1) * 2);
                    vit_1 = vit_1 - (especial_1);
                    System.out.println(name_1 + " realiza su ataque con tremenda fiereza, golpeando a " + name_2 + ", que cae al suelo e intenta sorprender a su rival con un ataque especial desde abajo.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
                ...
                if ((accion_1 == 2) && (accion_2 == 3)) {
                    vit_1 = especial_2 - (defensa_jugador1/2);
                ...
                if ((accion_1 == 3) && (accion_2 == 1)) {
                    vit_2 = vit_2 - especial_1;
                    vit_1 = vit_1 - ataque_jugador2;
                    System.out.println(name_1 + " carga su ataque especial golpeando en la cabeza a " + name_2 + ", que responde con un golpe desde la cintura.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
                if ((accion_1 == 3) && (accion_2 == 2)) {
                    vit_2 = vit_2 - (especial_1 - (defensa_jugador2/2));
                    System.out.println(name_1 + " carga su ataque especial golpeando en la cabeza a " + name_2 + ", que se lo espera e intenta mitigar el daño cubriéndose.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
                if ((accion_1 == 3) && (accion_2 == 3)) {
                    vit_2 = vit_2 - especial_1;
                    vit_1 = vit_1 - especial_2;
                    System.out.println("Ambos rivales realizan sendos ataques especiales generando una ráfaga de golpes intercalados sin control.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
                if ((accion_1 == 3) && (accion_2 == 4)) {
                    vit_2 = vit_2 - especial_1;
                    vit_2 = vit_2 + (Math.random()*50);
                    System.out.println(name_1 + " carga su ataque especial golpeando en la cabeza a " + name_2 + ", ante la gran cantidad de daño, decide utilizar una poción.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
                ...
                if ((accion_1 == 4) && (accion_2 == 3)) {
                    vit_1 = vit_1 - especial_2;
                    vit_1 = vit_1 + (Math.random()*50);
                    System.out.println(name_2 + " utiliza su ataque especial, dejando muy malherido a " + name_1 + " que decide curarse usando una poción.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                }
...
segundo jugador que el primero */
            if (primer_ataque_1<primer_ataque_2) {
                ...
                if ((ataque_1 == 3) && (contador_especial_1 == 1)) {
                    System.out.println("¡Ya has gastado la habilidad especial! Pierdes el turno.");
                }
                ...
                if ((accion_2 == 1) && (accion_1 == 3) && (critico_2 >= 25)) {
                    vit_1 = vit_1 - (ataque_jugador2);
                    vit_2 = vit_2 - (especial_2);
                    System.out.println(name_2 + " realiza un golpeo tremendo haciendo tambalear a " + name_1 + " e hiriéndolo de gravedad. " + name_1 + "realiza su ataque especial buscando sorprender.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                }
                if ((accion_2 == 1) && (accion_1 == 3) && (critico_2 <= 25)) {
                    vit_1 = vit_1 - ((ataque_jugador2) * 2);
                    vit_2 = vit_2 - (especial_2);
                    System.out.println(name_2 + " realiza su ataque con tremenda fiereza, golpeando a " + name_1 + ", que cae al suelo e intenta sorprender a su rival con un ataque especial desde abajo.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                }
                ...
                if ((accion_2 == 2) && (accion_1 == 3)) {
                    vit_2 = especial_1 - (defensa_jugador2/2);
                ...
                if ((accion_2 == 3) && (accion_1 == 1)) {
                    vit_1 = vit_1 - especial_2;
                    vit_2 = vit_2 - ataque_jugador1;
                    System.out.println(name_2 + " carga su ataque especial golpeando en la cabeza a " + name_1 + ", que responde con un golpe desde la cintura.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                }
                if ((accion_2 == 3) && (accion_1 == 2)) {
                    vit_1 = vit_1 - (especial_2 - (defensa_jugador1/2));
                    System.out.println(name_2 + " carga su ataque especial golpeando en la cabeza a " + name_1 + ", que se lo espera e intenta mitigar el daño cubriéndose.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                }
                ...
                if ((accion_2 == 3) && (accion_1 == 4)) {
                    vit_1 = vit_1 - especial_2;
                    vit_1 = vit_1 + (Math.random()*50);
                    System.out.println(name_2 + " carga su ataque especial golpeando en la cabeza a " + name_1 + ", ante la gran cantidad de daño, decide utilizar una poción.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                }
                ...
                if ((accion_2 == 4) && (accion_1 == 3)) {
                    vit_2 = vit_2 - especial_1;
                    vit_2 = vit_2 + (Math.random()*50);
                    System.out.println(name_1 + " utiliza su ataque especial, dejando muy malherido a " + name_2 + " que decide curarse usando una poción.");
                    System.out.println("A " + name_1 + " le quedan " + vit_1 + " de vida.");
                    System.out.println("A " + name_2 + " le quedan " + vit_2 + " de vida.");
                }
